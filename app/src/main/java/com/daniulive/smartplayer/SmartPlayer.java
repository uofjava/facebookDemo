...
import com.videoengine.NTVideoDataCallback;
		...
		builderUrl.setPositiveButton("确认",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						String fullUrl = getFacebookStreamUrl();

//						String fullUrl = "rtmps://live-api-s.facebook.com:443/rtmp/115195869757432?s_bl=1&s_sml=0&s_sw=0&s_vt=api-s&a=Abw0wJq6tw_BtlS5";
//                                inputUrlTxt.getText().toString();
	...
	private void InitAndSetConfig() {
		...
		playbackUrl = "rtsp://192.168.31.102:554/test.sdp";
	...
	private String getFacebookStreamUrl(){
			...
			request = GraphRequest.newPostRequest(
					...
					new GraphRequest.Callback() {
						...
						public void onCompleted(GraphResponse response) {
							...
							Log.i(TAG,"facebook live_video back："+response.toString());
							JSONObject streamObj = response.getJSONObject();
							try {
								String url = streamObj.getString("stream_url");
								String secure_url = streamObj.getString("secure_stream_url");
								String videoId = streamObj.getString("id");
								SaveInputRelayUrl("rtmp://live-api-s.facebook.com:80/rtWW1mp/913206155679102?s_bl=0&s_sw=0&s_vt=api-s&a=Abwd8nCATQd7yBsE");
